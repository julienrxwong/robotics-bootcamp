...
// these two lines lowkey define the package.
#include <Wire.h>
...
//it tells the servo drvier pwm to be 0 x 40
//it is assigning pwm to adafruit... so you just say pwm instead of adafruit...
// -----------------------------------------------------------------------
...
//wire makes the ic2 communication start  
//pwm makes the driver talk to the micro controller
